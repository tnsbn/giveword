...
"use strict";
/*!************************************!*\
  !*** ./resources/js/alone/chat.js ***!
  \************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var lodash_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/lang.js */ "./node_modules/lodash/lang.js");
/* harmony import */ var lodash_lang_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_lang_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lodash_string_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/string.js */ "./node_modules/lodash/string.js");
/* harmony import */ var lodash_string_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash_string_js__WEBPACK_IMPORTED_MODULE_1__);
...
(function ($, window, document) {
  ...
  $.extend(Component.prototype, {
    ...
    listenBubbleModal: function listenBubbleModal(el) {
      var local = this;
        ...
        local.modalChat.on('click', '.load-name', function (event) {
          $.ajax({
            ...
            if (data.name !== undefined) {
              var title = local.modalChat.find('.modal-title');
        ...
        function listener() {
          ...
          $.ajax({
            ...
            if (data.messages !== undefined) {
              var sortKeys = Object.keys(data['messages']);
              sortKeys.sort();
              sortKeys.map(function (key) {
                var time = new Date((0,lodash_lang_js__WEBPACK_IMPORTED_MODULE_0__.toNumber)(key) * 1000);
                time = (0,lodash_string_js__WEBPACK_IMPORTED_MODULE_1__.padStart)(time.getHours().toString(), 2, '0') + ':' + (0,lodash_string_js__WEBPACK_IMPORTED_MODULE_1__.padStart)(time.getMinutes().toString(), 2, '0') + ':' + (0,lodash_string_js__WEBPACK_IMPORTED_MODULE_1__.padStart)(time.getSeconds().toString(), 2, '0');
    ...
    listenChatCenter: function listenChatCenter(el) {
      var local = this;
      $(document).ready(function () {
        local.chatSection = $(el).find('.chat-section');
        $(el).on('change', '#online-chat', function (event) {
          var chkbox = document.getElementById('online-chat');
          var data = {
            'is_online': chkbox.checked,
            '_token': csrfToken
          };
          $.ajax({
            type: "POST",
        ...
        local.modalChat.on('click', '.user-item', function (event) {
          ...
          $.ajax({
            ...
            var chatBox = $(local.element).find('.chat-box');
        ...
        local.modalChat.on('click', '.btn-send', function (event) {
          var msg = local.modalChat.find('#message').val();
          if (msg.trim() === '') {
            return '';
          }
          var data = {
    ...
    showModalChat: function showModalChat(id) {
