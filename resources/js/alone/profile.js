  ...
  $.extend(Component.prototype, {
    ...
    listenProfile: function (el) {
      ...
      $(document).ready(function () {
        ...
        // Utility functions
        let clearFormPassword = function () {
        ...
        local.formProfile.on('click', '.btn-edit', function (event) {
          ...
          let controlId = $(this).data('edit');
          let control = local.formProfile.find('#' + controlId);
    ...
    checkRequire: function (ele) {
      let valid = true;
      let group = $(ele).closest('.form-group');
