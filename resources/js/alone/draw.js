...
;(function ($, window, document) {
  ...
  $.extend(Component.prototype, {
    ...
    listenEvents: function (el) {
      let local = this;
      $(document).ready(function () {
        const canvas = document.getElementById('canvas');
        const btnRandom = $(local.element).find('.btn-random');
        const btnUndo = $(local.element).find('.btn-undo');
        const btnClear = $(local.element).find('.btn-clear');
        const btnSubmit = $(local.element).find('.btn-submit');
        ...
        let drawCollapse = document.getElementById('collapse-draw')
