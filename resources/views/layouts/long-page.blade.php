...
{{--  <link rel="stylesheet" href="/css/bootstrap.css">--}}
  ...
  <script src="/js/alone/long-page.js"></script>
  @yield('script')
</head>
<body class="long-page">

<div>
  <div class="main_menu_bg navbar-top">
    <div class="container">
      <div class="row">
        <div class="nave_menu">
...
{{--                      <a id="drop1" href="#" role="button" class="dropdown-toggle" data-bs-toggle="dropdown">Dropdown <b class="caret"></b></a>--}}
